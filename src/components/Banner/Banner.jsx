...
const Banner = () => {
    return (
        <div className='bg-gray-50 p-10'>
            <div className='md:flex gap-20 items-center md:mx-40'>
            <div>
            ...
            <button className='bg-gradient-to-r from-indigo-400 to-violet-600 mb-16 p-4 rounded-xl text-white font-semibold '>Get Started</button>
